(function () {
    ...
    HelloWorld.prototype.onRandomEcho = function (onRandomEcho) {
        ...
        var onRandomEchoHandlerId = blackberry.events.registerEventHandler('onRandomEcho', onRandomEcho);
        
        return makeCall('onRandomEcho', { 'handlerId' : onRandomEchoHandlerId });
    };
